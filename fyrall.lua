patch.init = function()
	...
	P["spectre"] = 0.5550854
	P["spectre3"] = 0.5857186
	P["notes"] = 0.2566327
	P["spectre2"] = 0.4857184
	P["phase"] = 0.1937055
	ST["octave"] = -1.0
	...
	MAP.link("contour",0.551557,"tone")
	MAP.link("contour","glide")
	MAP.link("contour","morph")
	MAP.link("contour",-0.390103,"sustain")
	MAP.link("contour","octave_up")
	MAP.link("contour","lens")
	MAP.link("contour",0.447236,"tempo")
	MAP.link("contour",0.808753,"ramp")
	MAP.link("contour",0.690196,"notes")
	MAP.link("contour",0.00168258,"energy")
	MAP.link("contour",-0.0324969,"timbre")
	MAP.link("contour",-0.0851217,"length")
	...
	MAP.link("freqs",-0.0899048,"notes")
	...
	MAP.link("notes",0.0976518,"stretchL")
	MAP.link("notes",-0.386998,"spectre3")
	MAP.link("notes",0.395174,"sustain")
	MAP.link("notes",-0.809833,"speed")
	MAP.link("notes",0.129416,"timbre")
	MAP.link("notes",-0.386998,"spectre1")
	MAP.link("notes",0.655365,"ramp")
	MAP.link("notes",0.127437,"stretchR")
	MAP.link("notes",0.225629,"tone")
	MAP.link("notes",-0.0579036,"energy")
	MAP.link("notes",0.117367,"notes")
	MAP.link("notes",-0.386998,"spectre2")
	MAP.link("notes",0.0258986,"length")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.256633, c = 0.649234, v = 0.5, o = -1, act=true}
