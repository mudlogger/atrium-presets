patch.init = function()
	...
	MAP.link("contour",0.0695575,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",-0.442656,"notes")
	MAP.link("lfo",-0.407854,"length")
	MAP.link("lfo",0.278047,"sustain")
	MAP.link("lfo",0.318217,"notes")
	MAP.link("lfo",0.374357,"energy")
	MAP.link("lfo",0.150702,"tone")
	MAP.link("notes",-0.186508,"sustain")
	MAP.link("clock","drone")
	MAP.link("clock",0.910922,"speed")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.711811, c = 0.671183, v = 0.515208, o = -1, act=true}
	cluster.cx[2] = {n = 0.711811, c = 0.671183, v = 0.515208, o = -2, act=true}
	cluster.cx[3] = {n = 0.938263, c = 0.671183, v = 0.515208, o = -2, act=true}
	cluster.cx[4] = {n = 0.938263, c = 0.671183, v = 0.515208, o = -1, act=true}
	cluster.cx[5] = {n = 0.599991, c = 0.671183, v = 0.515208, o = -1, act=true}
end
