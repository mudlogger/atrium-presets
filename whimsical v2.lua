patch.init = function()
	...
	_params.spectre1.vx = {0.4125068,0.5051127,0.4134593,0.6017084,0.5277777,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.5939212,0.5488491,0.7048175,0.8385924,0.8074407,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {1.0,0.6990569,1.0,0.9946759,1.0,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",-0.719197,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",-0.556041,"length")
	MAP.link("lfo",-0.336179,"sustain")
	MAP.link("lfo",0.0216191,"ramp")
	MAP.link("lfo",0.0477375,"energy")
	MAP.link("notes",-0.65506,"sustain")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.448565, c = 0.153228, v = 0.5, o = -1, act=true}
	cluster.cx[2] = {n = 0.493002, c = 0.153228, v = 0.5, o = -1, act=true}
	cluster.cx[3] = {n = 0.468304, c = 0.153228, v = 0.5, o = -1, act=true}
	cluster.cx[4] = {n = 0.49817, c = 0.153228, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.490691, c = 0.153228, v = 0.5, o = -1, act=true}
end
