patch.init = function()
	...
	MAP.link("contour",0.946157,"tone")
	MAP.link("contour",0.102381,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("loudness","lens")
	MAP.link("lfo",-0.0985997,"sustain")
	MAP.link("lfo",0.105668,"notes")
	MAP.link("lfo","lens")
	MAP.link("lfo",-0.976111,"tone")
	MAP.link("lfo",-0.185775,"length")
	MAP.link("notes",-0.15843,"tone")
	MAP.link("notes",0.0949822,"sustain")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.300148, c = 0.459425, v = 0.5, o = 0, act=true}
	cluster.cx[2] = {n = 0.387454, c = 0.459425, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.34695, c = 0.463931, v = 0.5, o = 1, act=true}
	cluster.cx[4] = {n = 0.672649, c = 0.463931, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.317927, c = 0.463931, v = 0.5, o = 0, act=true}
end
