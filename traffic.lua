patch.init = function()
	...
	Drone_chan_lookup[1] = {0, 1, 1, 1, 0}
	Drone_chan_lookup[2] = {0, 1, 0, 1, 0}
	Drone_chan_lookup[3] = {0, 1, 1, 0, 1}
	Drone_chan_lookup[4] = {1, 0, 0, 1, 0}
	Drone_chan_lookup[5] = {0, 1, 0, 1, 1}
	Drone_chan_lookup[6] = {0, 1, 0, 1, 1}
	Drone_chan_lookup[7] = {1, 1, 0, 1, 1}
	Drone_chan_lookup[8] = {0, 1, 0, 0, 1}
	Drone_chan_lookup[9] = {1, 0, 1, 0, 0}
	Drone_chan_lookup[10] = {1, 1, 1, 1, 0}
	Drone_chan_lookup[11] = {0, 0, 0, 1, 0}
	...
	MAP.link("contour",-0.194588,"sustain")
	MAP.link("contour",0.651889,"notes")
	MAP.link("contour",-0.834522,"timbre")
	MAP.link("contour",0.484168,"tone")
	...
	cluster.cx[2] = {n = 0, c = 0.971942, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0, c = 0.971942, v = 0.5, o = -1, act=true}
	cluster.cx[4] = {n = 0, c = 0.971942, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0, c = 0.971942, v = 0.5, o = 0, act=true}
end
