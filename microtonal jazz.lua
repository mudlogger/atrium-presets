patch.init = function()
	...
	_params.spectre1.vx = {0.1965743,0.4,0.3,0.5,0.5094752,0.3786976,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.3965743,0.5,0.4,0.6,0.6260623,0.3786976,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.7965744,0.6,0.7,0.7,0.6459866,0.3786976,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",0.489423,"length")
	MAP.link("contour",0.0788045,"sustain")
	MAP.link("contour",0.784066,"timbre")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("lfo",0.274464,"notes")
	MAP.link("lfo",0.337931,"spectre1")
	MAP.link("lfo",0.176405,"length")
	MAP.link("lfo",0.111837,"stretchR")
	MAP.link("lfo",-0.671794,"energy")
	MAP.link("lfo",-0.179582,"spectre")
	MAP.link("lfo",0.337931,"spectre2")
	MAP.link("lfo",0.687619,"stretchL")
	MAP.link("lfo",0.337931,"spectre3")
	MAP.link("notes",-0.100572,"length")
	MAP.link("notes",0.525011,"sustain")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.677445, c = 0, v = 0.5, o = 0, act=true}
	cluster.cx[2] = {n = 0.293565, c = 0, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.000473492, c = 0.5, v = 0.5, o = 0, act=true}
	cluster.cx[4] = {n = 0.258878, c = 0, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.258878, c = 0, v = 0.5, o = -1, act=true}
end
