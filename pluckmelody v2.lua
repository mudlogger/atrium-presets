patch.init = function()
	...
	MAP.link("contour",-0.0342903,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain^",-0.959389,"speed")
	MAP.link("sustain_","lens")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.135648,"sustain")
	MAP.link("lfo",-0.373371,"sustain")
	MAP.link("lfo",0.22792,"energy")
	MAP.link("lfo",-0.0900335,"notes")
	MAP.link("lfo",-0.549676,"length")
	MAP.link("notes",0.19986,"ramp")
	MAP.link("notes",0.246709,"sustain")
	MAP.link("notes",0.556188,"length")
	MAP.link("clock",-0.598088,"length")
	MAP.link("clock","drone")
	MAP.link("clock",0.959389,"sustain")
	MAP.link("clock","lens")
