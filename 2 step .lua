patch.init = function()
	...
	P["spectre"] = 0.0001832873
	P["spectre3"] = 0.7955969
	P["notes"] = 0.650089
	P["spectre2"] = 0.5934314
	P["phase"] = 0.0
	ST["octave"] = 0.0
	ST["midicc_select"] = 1.0
	ST["quant_active"] = 1.0
	_params["lens"].seq.start = 1; _params["lens"].seq.limit = 2
	P["lens"] = 2.0
	...
	P["drone"] = 1.0
	P["spectre1"] = 0.4078539
	P["ramp"] = 0.0007636969
	ST["current_extension"] = nil
	P["timbre"] = 0.001176093
	P["energy"] = 0.09353759
	P["tmode"] = 2.0
	...
	_params.spectre1.vx = {0.003091416,0.4078539,0.3,0.5,0.4527878,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.2750939,0.5934314,0.4,0.6,0.6114351,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.7307022,0.7955969,0.7,0.7,0.7816493,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("freqs",0.0332577,"sustain")
	MAP.link("freqs",-0.640292,"notes")
	MAP.link("lfo",0.0730987,"notes")
	MAP.link("lfo",-0.481456,"energy")
	MAP.link("notes",-0.244374,"sustain")
	MAP.link("notes",-0.36158,"energy")
	MAP.link("clock",0.291329,"sustain")
	MAP.link("clock","lens")
	MAP.link("step",-0.167668,"notes")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.650089, c = 0.353798, v = 0.5, o = 0, act=true}
	cluster.cx[2] = {n = 0.872722, c = 0.156733, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.849155, c = 0.353798, v = 0.5, o = 0, act=true}
	cluster.cx[4] = {n = 0.650089, c = 0.846283, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.999053, c = 0.000183287, v = 0.5, o = -1, act=true}
end
