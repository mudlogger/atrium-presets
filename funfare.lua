patch.init = function()
	...
	MAP.link("contour",0.0649575,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("lfo",-0.0173486,"timbre")
	MAP.link("lfo","shape")
	MAP.link("lfo",-0.344766,"energy")
	MAP.link("lfo",-0.102833,"notes")
	MAP.link("lfo",0.131744,"length")
	MAP.link("lfo",0.412106,"ramp")
	MAP.link("notes",0.0777444,"length")
	MAP.link("notes",0.0676418,"sustain")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.754502, c = 0.207053, v = 0.5, o = 2, act=true}
	cluster.cx[2] = {n = 0.467561, c = 0.207053, v = 0.5, o = 1, act=true}
	cluster.cx[3] = {n = 0.467561, c = 0.207053, v = 0.5, o = 2, act=true}
	cluster.cx[4] = {n = 0.486353, c = 0.207053, v = 0.5, o = 2, act=true}
	cluster.cx[5] = {n = 0.140319, c = 0.170472, v = 0.5, o = 2, act=true}
end
