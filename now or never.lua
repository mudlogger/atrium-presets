patch.init = function()
	...
	P["spectre"] = 0.4952421
	P["spectre3"] = 0.8082918
	P["notes"] = 0.00093171
	P["spectre2"] = 0.6308929
	P["phase"] = 0.04545074
	ST["octave"] = -1.0
	...
	_params.spectre1.vx = {0.0,0.07564476,0.0,0.5065041,0.0,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.1716362,0.2372647,0.0,0.6308929,0.01913038,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.6464679,0.5314431,0.05706669,0.8082918,0.1170136,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",-0.0863739,"sustain")
	MAP.link("contour",0.329064,"spectre2")
	MAP.link("contour",0.329064,"spectre1")
	MAP.link("contour",0.329064,"spectre3")
	MAP.link("strum",2,"gate")
	MAP.link("sustain^",0.0807991,"notes")
	MAP.link("sustain^",0.00366575,"speed")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.128451,"length")
	MAP.link("lfo",0.0657608,"tone")
	MAP.link("lfo",-0.0674171,"stretchL")
	MAP.link("lfo",0.616753,"volume")
	MAP.link("lfo",0.55638,"sustain")
	MAP.link("lfo",0.595442,"notes")
	MAP.link("lfo",-0.735638,"tempo")
	MAP.link("lfo",-0.228614,"length")
	MAP.link("lfo",-0.614403,"stretchR")
	MAP.link("lfo",-0.152375,"energy")
	MAP.link("lfo",0.701021,"ramp")
	MAP.link("notes",0.212024,"sustain")
	MAP.link("notes",0.379946,"timbre")
	...
	cluster.cx[2] = {n = 0.00093171, c = 0.996136, v = 0.5, o = -2, act=true}
	cluster.cx[3] = {n = 0.10064, c = 0.996136, v = 0.5, o = -1, act=true}
	cluster.cx[4] = {n = 0.435567, c = 0.996136, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.482611, c = 0.996136, v = 0.5, o = -2, act=true}
end
