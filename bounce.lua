patch.init = function()
	...
	cluster.cx[2] = {n = 0.0416988, c = 0.5, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.357364, c = 0.5, v = 0.5, o = -2, act=true}
	cluster.cx[4] = {n = 0.201616, c = 0.5, v = 0.5, o = -2, act=true}
	cluster.cx[5] = {n = 0, c = 0.5, v = 0.5, o = 0, act=true}
end
