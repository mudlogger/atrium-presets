patch.init = function()
	...
	P["spectre"] = 0.01137908
	P["spectre3"] = 0.604051
	P["notes"] = 0.0003207527
	...
	_params.spectre1.vx = {0.1965743,0.4,0.3,0.5,0.4903367,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.3965743,0.5,0.4,0.6,0.6193601,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.7965744,0.6,0.7,0.7,0.6874576,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("lfo",0.342252,"sustain")
	MAP.link("lfo",-0.0221995,"volume")
	MAP.link("lfo",1,"tone")
	MAP.link("lfo",-0.102907,"spectre1")
	MAP.link("lfo",-0.102907,"spectre2")
	MAP.link("lfo",-0.102907,"spectre3")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.000320753, c = 0.5, v = 0.5, o = -2, act=true}
end
