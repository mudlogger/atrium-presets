patch.init = function()
	...
	P["drone"] = 1.0
	P["spectre1"] = 0.2322397
	P["ramp"] = 0.0
	ST["current_extension"] = nil
	P["timbre"] = 0.5804402
	P["energy"] = 0.166547
	P["tmode"] = 3.0
	P["stretchR"] = 0.6627709
	...
	MAP.link("contour",-0.188939,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("lfo",-0.317912,"sustain")
	MAP.link("lfo",-0.113992,"energy")
	MAP.link("notes",0.187319,"sustain")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.467945, c = 0.731301, v = 0.5, o = 0, act=true}
	cluster.cx[2] = {n = 0.448018, c = 0.731301, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.448018, c = 0.655252, v = 0.5, o = 0, act=true}
	cluster.cx[4] = {n = 0.448018, c = 0.764109, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.510659, c = 0.764109, v = 0.5, o = -1, act=true}
end
