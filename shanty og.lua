patch.init = function()
	...
	MAP.link("contour",0.331453,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("lfo",-0.336179,"sustain")
	MAP.link("lfo","lens")
	MAP.link("lfo",0.0477375,"energy")
	MAP.link("lfo",-0.0639889,"timbre")
	MAP.link("lfo",-0.508821,"ramp")
	MAP.link("notes",-0.47685,"sustain")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
