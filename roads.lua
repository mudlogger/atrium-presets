patch.init = function()
	...
	P["spectre"] = 0.5593316
	P["spectre3"] = 0.8457946
	P["notes"] = 0.432497
	P["spectre2"] = 0.5824643
	P["phase"] = 0.1288593
	ST["octave"] = -2.0
	...
	_params.spectre1.vx = {0.1820971,0.4,0.3,0.1829912,0.218673,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.3820969,0.5,0.4,0.5824643,0.3773205,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.7820975,0.6,0.7,0.8457946,0.5475348,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",0.0375524,"speed")
	...
	MAP.link("freqs",0.269899,"length")
	MAP.link("freqs",-0.413151,"sustain")
	MAP.link("freqs",0.128109,"ramp")
	MAP.link("freqs",-0.0857085,"speed")
	MAP.link("lfo",0.911656,"sustain")
	MAP.link("lfo",0.386487,"spectre1")
	MAP.link("lfo",0.66087,"speed")
	MAP.link("lfo",0.408375,"stretchR")
	MAP.link("lfo",-0.038573,"length")
	MAP.link("lfo",0.386487,"spectre2")
	MAP.link("lfo",-0.529196,"energy")
	MAP.link("lfo",-0.693526,"tone")
	MAP.link("lfo",-0.443395,"stretchL")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.432497, c = 0.180187, v = 0.5, o = 0, act=true}
