patch.init = function()
	...
	P["spectre"] = 0.4454339
	P["spectre3"] = 0.6291044
	P["notes"] = 0.8074313
	P["spectre2"] = 0.5291041
	P["phase"] = 0.05998089
	ST["octave"] = -2.0
	...
	_params.spectre1.vx = {0.2149018,0.4206396,0.3883009,0.6311102,0.6565548,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.4097364,0.5291041,0.4881899,0.7387655,0.8175927,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.8097364,0.6291044,0.7881896,0.8387654,0.9878069,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",0.322186,"length")
	MAP.link("contour",-0.0485317,"sustain")
	MAP.link("contour",0.640522,"ramp")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.611994,"time")
	MAP.link("freqs",-0.440885,"speed")
	MAP.link("freqs",0.41568,"tempo")
	MAP.link("freqs","lowcut")
	MAP.link("lfo",0.187014,"sustain")
	MAP.link("lfo",0.606439,"phase")
	MAP.link("lfo",0.530051,"tone")
	MAP.link("lfo",-0.154025,"timbre")
	MAP.link("lfo",-0.0722342,"spectre1")
	MAP.link("lfo",-0.0497536,"energy")
	MAP.link("lfo",-0.235583,"notes")
	MAP.link("lfo",-0.0722342,"spectre2")
	MAP.link("lfo",-0.0722342,"spectre3")
	MAP.link("notes",-0.297527,"sustain")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.807431, c = 0.0775025, v = 0.5, o = -2, act=true}
	cluster.cx[2] = {n = 0.868405, c = 0.0775025, v = 0.5, o = -2, act=true}
	cluster.cx[3] = {n = 0.97349, c = 0.0775025, v = 0.5, o = -2, act=true}
	cluster.cx[4] = {n = 0.807431, c = 0.0775025, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.807431, c = 0.0775025, v = 0.5, o = 0, act=true}
end
