patch.init = function()
	...
	P["spectre"] = 0.4032014
	P["spectre3"] = 0.9321913
	P["notes"] = 0.731576
	P["spectre2"] = 0.6004627
	P["phase"] = 0.0
	ST["octave"] = -1.0
	...
	_params.spectre1.vx = {0.0685114,0.2696393,0.4722072,0.5176067,0.4328136,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.2215251,0.4242115,0.6004627,0.6499965,0.6279796,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.6413726,0.586616,0.9321913,0.8356699,0.9263688,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",0.485133,"sustain")
	MAP.link("contour",-0.392097,"speed")
	MAP.link("contour",0.392695,"tempo")
	MAP.link("contour",0.190933,"spectre1")
	MAP.link("contour",0.190933,"spectre2")
	MAP.link("contour",0.239138,"volume")
	MAP.link("contour",0.190933,"spectre3")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.386633,"sustain")
	MAP.link("freqs",0.0248749,"volume")
	MAP.link("lfo",1,"tempo")
	MAP.link("lfo",0.505076,"sustain")
	MAP.link("lfo","octave_up")
	MAP.link("lfo",0.730407,"notes")
	MAP.link("lfo","octave_down")
	MAP.link("lfo",0.3335,"timbre")
	MAP.link("lfo",-0.115336,"tone")
	MAP.link("lfo",-0.205877,"speed")
	MAP.link("lfo",0.166471,"ramp")
	MAP.link("lfo",0.346754,"stretchR")
	MAP.link("lfo",0.0857394,"spectre1")
	MAP.link("lfo",-0.0101877,"length")
	MAP.link("lfo",0.0857394,"spectre2")
	MAP.link("lfo",0.660522,"energy")
	MAP.link("lfo",-0.37126,"stretchL")
	MAP.link("lfo",0.0857394,"spectre3")
	MAP.link("notes",-0.79609,"spectre2")
	MAP.link("notes",0.51771,"sustain")
	MAP.link("notes",-0.79609,"spectre1")
	MAP.link("notes",-0.79609,"spectre3")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.731576, c = 0.000962258, v = 0, o = -2, act=true}
	cluster.cx[2] = {n = 0.731576, c = 0.000962258, v = 0, o = -1, act=true}
	cluster.cx[3] = {n = 0.731576, c = 0.342778, v = 0, o = -1, act=true}
	cluster.cx[4] = {n = 0.834869, c = 0.611747, v = 0, o = -1, act=true}
	cluster.cx[5] = {n = 0.834869, c = 0.776527, v = 0, o = -1, act=true}
end
