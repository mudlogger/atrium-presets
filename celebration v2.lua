patch.init = function()
	...
	MAP.link("contour",0.192268,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("lfo",0.10181,"sustain")
	MAP.link("lfo",0.384057,"notes")
	MAP.link("lfo",-0.0365135,"tone")
	MAP.link("lfo",0.511454,"energy")
	MAP.link("lfo",-0.415372,"length")
	MAP.link("lfo",-0.613596,"ramp")
	MAP.link("notes",-0.0739171,"sustain")
	MAP.link("clock",0.557863,"sustain")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.557682, c = 0.151609, v = 0.5, o = -1, act=true}
	cluster.cx[2] = {n = 0.557682, c = 0.151609, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.557682, c = 0.151609, v = 0.5, o = -2, act=true}
end
