patch.init = function()
	...
	_params.spectre1.vx = {0.1965743,0.4,0.3,0.5,0.1273951,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.3965743,0.5,0.4,0.6,0.2860435,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.7965744,0.6,0.7,0.7,0.4562569,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",-0.207619,"sustain")
	MAP.link("contour",0.198332,"notes")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("lfo",0.96363,"sustain")
	MAP.link("lfo",0.269751,"notes")
	MAP.link("lfo",-0.418467,"timbre")
	MAP.link("lfo",-0.379139,"tone")
	MAP.link("lfo",-0.249558,"length")
	MAP.link("lfo",-0.210857,"energy")
	MAP.link("lfo",0.43707,"ramp")
	MAP.link("notes",0.24226,"sustain")
	MAP.link("notes",0.694748,"energy")
	MAP.link("notes",-0.111057,"tone")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.619816, c = 0.377388, v = 0.5, o = -1, act=true}
	cluster.cx[2] = {n = 0.380092, c = 0.377388, v = 0.5, o = -1, act=true}
	cluster.cx[3] = {n = 0.380092, c = 0.377388, v = 0.5, o = 0, act=true}
	cluster.cx[4] = {n = 0.619816, c = 0.377388, v = 0.5, o = -2, act=true}
end
