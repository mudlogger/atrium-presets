patch.init = function()
	...
	MAP.link("contour",-0.101816,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.256816,"sustain")
	MAP.link("lfo",-0.703096,"sustain")
	MAP.link("lfo",-0.673901,"ramp")
	MAP.link("lfo",-0.217381,"energy")
	MAP.link("lfo",-0.00795135,"length")
	MAP.link("notes",0.069518,"sustain")
	MAP.link("clock",0.437751,"sustain")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
