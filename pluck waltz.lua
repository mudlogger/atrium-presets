patch.init = function()
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.451773, c = 0.5, v = 0.5, o = -2, act=true}
	cluster.cx[2] = {n = 0.36075, c = 0.5, v = 0.5, o = -2, act=true}
	cluster.cx[3] = {n = 0.339509, c = 0.684395, v = 0.531991, o = -2, act=true}
	cluster.cx[4] = {n = 0.2197, c = 0.5, v = 0.5, o = -2, act=true}
	cluster.cx[5] = {n = 0.481908, c = 0.5, v = 0.5, o = -2, act=true}
end
