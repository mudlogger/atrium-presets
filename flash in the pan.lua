patch.init = function()
	...
	_params.spectre1.vx = {0.3904303,0.4,0.3,0.5,0.5094752,1.0,0.9092063,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.5904304,0.5,0.4,0.6,0.6260623,1.0,0.9804068,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.9904306,0.6,0.7,0.7,0.6459866,1.0,1.0,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",-0.676644,"notes")
	MAP.link("contour",0.504514,"timbre")
	MAP.link("contour",-0.0777665,"spectre1")
	MAP.link("contour",-0.0595312,"length")
	MAP.link("contour",0.503825,"phase")
	MAP.link("contour",-0.0777665,"spectre2")
	MAP.link("contour",0.103304,"energy")
	MAP.link("contour",-0.908992,"tone")
	MAP.link("contour",-0.0777665,"spectre3")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.257833,"speed")
	MAP.link("lfo",-0.498716,"time")
	MAP.link("lfo",0.288354,"sustain")
	MAP.link("lfo","octave_up")
	MAP.link("lfo",-0.431586,"speed")
	MAP.link("lfo","octave_down")
	MAP.link("lfo",-0.0880606,"timbre")
	MAP.link("lfo",-0.464251,"tone")
	MAP.link("lfo",-0.828487,"notes")
	MAP.link("lfo",-0.164586,"length")
	MAP.link("lfo",-0.357727,"stretchR")
	MAP.link("lfo",0.291542,"spectre1")
	MAP.link("lfo",-0.572458,"spectre")
	MAP.link("lfo",-0.401,"energy")
	MAP.link("lfo",0.291542,"spectre2")
	MAP.link("lfo",0.458172,"stretchL")
	MAP.link("lfo",0.291542,"spectre3")
	MAP.link("notes",0.570778,"sustain")
	MAP.link("notes",0.0985086,"notes")
	MAP.link("notes",0.562214,"tone")
	MAP.link("notes",-0.0333735,"spectre")
	MAP.link("notes",-0.892143,"spectre2")
	MAP.link("notes",-0.892143,"spectre1")
	MAP.link("notes",-0.892143,"spectre3")
	MAP.link("clock",0.443784,"sustain")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 1, c = 0, v = 0.5, o = -1, act=true}
	cluster.cx[2] = {n = 0.999832, c = 0, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.521269, c = 0, v = 0.5, o = 1, act=true}
	cluster.cx[4] = {n = 0.92945, c = 0, v = 0.5, o = 1, act=true}
	cluster.cx[5] = {n = 0.792366, c = 0, v = 0.5, o = 1, act=true}
end
