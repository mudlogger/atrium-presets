patch.init = function()
	...
	P["spectre"] = 0.8525759
	P["spectre3"] = 0.7809982
	P["notes"] = 0.0007178751
	P["spectre2"] = 0.6107841
	P["phase"] = 0.5628889
	ST["octave"] = 0.0
	...
	MAP.link("sustain^",0.763828,"notes")
	MAP.link("sustain^",0.65691,"timbre")
	MAP.link("sustain^",-1,"tone")
	MAP.link("sustain^","lens")
	MAP.link("sustain^",-0.776505,"ramp")
	MAP.link("sustain^","loop")
	MAP.link("sustain^","drone")
	MAP.link("sustain^",0.911466,"spectre")
	MAP.link("sustain^",1,"energy")
	MAP.link("sustain^",0.400118,"speed")
	MAP.link("sustain^",0.797828,"time")
	MAP.link("sustain^",0.512785,"length")
	MAP.link("sustain","gate")
	MAP.link("freqs",1,"tempo")
	MAP.link("freqs",-0.916482,"sustain")
	MAP.link("freqs",0.922976,"speed")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.000717875, c = 0.802737, v = 0.5, o = 0, act=true}
end
