patch.init = function()
	...
	P["spectre"] = 0.3820012
	P["spectre3"] = 0.7917951
	P["notes"] = 0.647936
	P["spectre2"] = 0.3792415
	P["phase"] = 0.050306
	ST["octave"] = 1.0
	...
	P["lowcut"] = 0.0
	ST["mto_notes"] = 0.0
	P["stretchL"] = 0.3368985
	ST["midi_dest"] = 1.0
	P["glide"] = 2.0
	_params["drone"].seq.start = 1; _params["drone"].seq.limit = 5
	P["drone"] = 1.0
	P["spectre1"] = 0.09008434
	P["ramp"] = 0.0005651357
	ST["current_extension"] = nil
	P["timbre"] = 0.3330329
	P["energy"] = 9.164363e-05
	P["tmode"] = 1.0
	P["stretchR"] = 0.6560584
	...
	_params.spectre1.vx = {0.204799,0.3630373,0.09008434,0.4714926,0.3350073,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.3862136,0.406774,0.3792415,0.7083765,0.61467,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.8064622,0.5569818,0.7917951,0.9175367,0.8547583,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",0.0483179,"ramp")
	MAP.link("contour",0.359915,"sustain")
	MAP.link("contour",-0.0857695,"tone")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("lfo",-0.486805,"ramp")
	MAP.link("lfo",-0.401377,"sustain")
	MAP.link("lfo","lens")
	MAP.link("lfo",0.0477375,"energy")
	MAP.link("lfo",-0.0639889,"timbre")
	MAP.link("lfo",-0.548856,"tone")
	MAP.link("lfo",0.0772162,"length")
	MAP.link("notes",-0.541324,"ramp")
	MAP.link("notes",-0.40268,"sustain")
	MAP.link("notes",0.554771,"tone")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.543767, c = 0.153228, v = 0.5, o = 1, act=true}
	cluster.cx[2] = {n = 0.527256, c = 0.153228, v = 0.5, o = 1, act=true}
	cluster.cx[3] = {n = 0.514594, c = 0.153228, v = 0.5, o = 1, act=true}
	cluster.cx[4] = {n = 0.484471, c = 0.153228, v = 0.5, o = 1, act=true}
	cluster.cx[5] = {n = 0.647936, c = 0.153228, v = 0.5, o = 1, act=true}
end
