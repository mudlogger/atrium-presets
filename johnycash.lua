patch.init = function()
	...
	_params.spectre1.vx = {0.1965743,0.4,0.3,0.5,0.4527878,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.5123528}
	_params.spectre2.vx = {0.3965743,0.5,0.4,0.6,0.6114351,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.5696754}
	_params.spectre3.vx = {0.7965744,0.6,0.7,0.7,0.7816493,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.6389871}
	...
	MAP.link("contour",-0.0408055,"volume")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("lfo",0.170934,"sustain")
	MAP.link("lfo",-0.0684489,"length")
	MAP.link("lfo",0.792032,"energy")
	MAP.link("lfo","lens")
	MAP.link("notes",1,"energy")
	MAP.link("notes",0.636901,"sustain")
	MAP.link("notes","shape")
	MAP.link("clock",0.432567,"sustain")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0, c = 1, v = 0.5, o = -1, act=true}
	cluster.cx[2] = {n = 0.357128, c = 0.841899, v = 0.5, o = -1, act=true}
	cluster.cx[3] = {n = 0.357128, c = 0.841899, v = 0.5, o = 0, act=true}
	cluster.cx[4] = {n = 0.34319, c = 0.762506, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.34319, c = 0.851843, v = 0.5, o = -1, act=true}
end
