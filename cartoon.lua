patch.init = function()
	...
	_params.spectre1.vx = {0.4643308,0.3555024,0.3,0.5,0.5579343,0.5,0.3647182,0.4527878,0.241575,0.2657811,0.5500293}
	_params.spectre2.vx = {0.6101564,0.592303,0.4,0.6,0.7165821,0.5,0.57066,0.6114351,0.5673178,0.4293588,0.5694344}
	_params.spectre3.vx = {0.9669349,0.908624,0.7,0.7,0.8867961,0.5,0.8502969,0.7816493,0.8831592,0.604051,0.6298262}
	...
	MAP.link("contour",-0.416328,"sustain")
	MAP.link("contour",0.121761,"speed")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.0596689,"sustain")
	MAP.link("lfo",0.241854,"sustain")
	MAP.link("lfo",-0.315431,"notes")
	MAP.link("lfo",0.0161992,"length")
	MAP.link("lfo",-0.601103,"stretchR")
	MAP.link("lfo",-0.00523907,"energy")
	MAP.link("lfo",0.291529,"stretchL")
	MAP.link("notes",0.0957396,"sustain")
	MAP.link("notes",-0.0831996,"energy")
	MAP.link("notes",-0.194889,"spectre2")
	MAP.link("notes",-0.194889,"spectre1")
	MAP.link("notes",0.228337,"tone")
	MAP.link("notes",-0.194889,"spectre3")
	MAP.link("clock",0.835402,"speed")
	MAP.link("clock",0.261095,"sustain")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.540972, c = 0.767943, v = 0.5, o = 0, act=true}
	cluster.cx[2] = {n = 0.376594, c = 0.811611, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.587598, c = 0.767943, v = 0.5, o = 0, act=true}
	cluster.cx[4] = {n = 0.540972, c = 1, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.540972, c = 0.968337, v = 0.5, o = -1, act=true}
end
