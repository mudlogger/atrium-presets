patch.init = function()
	...
	MAP.link("lfo",-0.755298,"tone")
	MAP.link("lfo",-0.0622042,"time")
	MAP.link("lfo",0.356904,"spectre2")
	MAP.link("lfo",0.356904,"spectre1")
	MAP.link("lfo",0.394382,"energy")
	MAP.link("lfo",0.00803652,"notes")
	MAP.link("lfo",0.356904,"spectre3")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.546822, c = 0.527883, v = 0.5, o = -1, act=true}
end
