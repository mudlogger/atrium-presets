patch.init = function()
	...
	MAP.link("contour",-0.246506,"sustain")
	MAP.link("contour",0.784066,"timbre")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.257833,"speed")
	MAP.link("lfo",0.0364653,"sustain")
	MAP.link("lfo",0.202288,"notes")
	MAP.link("lfo",-0.634605,"spectre1")
	MAP.link("lfo",-0.188801,"length")
	MAP.link("lfo",0.107134,"stretchR")
	MAP.link("lfo",0.0162058,"speed")
	MAP.link("lfo",-0.634605,"spectre2")
	MAP.link("lfo",-0.401,"energy")
	MAP.link("lfo",-0.705657,"stretchL")
	MAP.link("lfo",-0.634605,"spectre3")
	MAP.link("notes",0.570778,"sustain")
	MAP.link("notes",0.0886985,"spectre1")
	MAP.link("notes",-0.0333735,"spectre")
	MAP.link("notes",0.0886985,"spectre2")
	MAP.link("notes",-0.652542,"notes")
	MAP.link("notes",0.562214,"tone")
	MAP.link("notes",0.0886985,"spectre3")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.659623, c = 0, v = 0.5, o = 2, act=true}
	cluster.cx[2] = {n = 0.659623, c = 0, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.730247, c = 0, v = 0.5, o = 0, act=true}
	cluster.cx[4] = {n = 0.969269, c = 0, v = 0.5, o = 0, act=true}
end
