patch.init = function()
	...
	MAP.link("contour",-0.578376,"spectre2")
	MAP.link("contour",0.784066,"timbre")
	MAP.link("contour",-0.578376,"spectre1")
	MAP.link("contour",-0.578376,"spectre3")
	...
	MAP.link("notes",0.114945,"spectre2")
	MAP.link("notes",-0.652542,"notes")
	MAP.link("notes",0.114945,"spectre1")
	MAP.link("notes",0.114945,"spectre3")
	MAP.link("clock","lens")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	cluster.cx[2] = {n = 0.0339234, c = 0, v = 0.5, o = 2, act=true}
	cluster.cx[3] = {n = 0.400758, c = 0, v = 0.5, o = 0, act=true}
end
