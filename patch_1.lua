patch.init = function()
	...
	MAP.link("lfo",-0.67425,"energy")
	MAP.link("lfo",0.112907,"sustain")
	MAP.link("clock","lens")
	MAP.link("notes",-0.37482,"sustain")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.482794, c = 0.320246, v = 0.5, o = 1, act=true}
end
