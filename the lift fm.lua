patch.init = function()
	...
	P["spectre"] = 0.9989308
	P["spectre3"] = 0.6537175
	P["notes"] = 1.0
	P["spectre2"] = 0.2537175
	P["phase"] = 0.2705478
	ST["octave"] = -1.0
	...
	_params.spectre1.vx = {0.05371745,0.4,0.3,0.5,0.4527878,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.2537175,0.5,0.4,0.6,0.6114351,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.6537175,0.6,0.7,0.7,0.7816493,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",-1,"sustain")
	MAP.link("strum",2,"gate")
	MAP.link("sustain^",0.020275,"ramp")
	MAP.link("sustain^",-1,"tempo")
	MAP.link("sustain^",0.0342354,"length")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.50857,"time")
	MAP.link("freqs",-0.0939628,"notes")
	MAP.link("lfo",0.527586,"sustain")
	MAP.link("lfo",1,"notes")
	MAP.link("lfo",0.583727,"time")
	MAP.link("lfo",-0.158974,"tempo")
	MAP.link("lfo",0.28558,"spectre1")
	MAP.link("lfo",-0.0455274,"length")
	MAP.link("lfo",-0.172888,"ramp")
	MAP.link("lfo",-0.576312,"stretchR")
	MAP.link("lfo",0.28558,"spectre3")
	MAP.link("lfo",0.636022,"energy")
	MAP.link("lfo",0.28558,"spectre2")
	MAP.link("lfo",-0.647822,"tone")
	MAP.link("lfo",0.737433,"stretchL")
	MAP.link("lfo",0.140664,"volume")
	MAP.link("notes",0.444535,"time")
	MAP.link("notes",0.525421,"sustain")
	MAP.link("notes",-0.164281,"spectre2")
	MAP.link("notes",-0.737411,"speed")
	MAP.link("notes",-0.164281,"spectre1")
	MAP.link("notes",-0.164281,"spectre3")
	MAP.link("clock",0.562096,"sustain")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 1, c = 0.895801, v = 0.5, o = -1, act=true}
	cluster.cx[2] = {n = 1, c = 0.895801, v = 0.5, o = -2, act=true}
	cluster.cx[3] = {n = 0.918984, c = 0.663989, v = 0.5, o = -1, act=true}
	cluster.cx[4] = {n = 0.960364, c = 0.895801, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.946281, c = 0.993463, v = 0.5, o = -2, act=true}
end
