patch.init = function()
	...
	MAP.link("contour",-0.53946,"ramp")
	MAP.link("contour",-0.956609,"sustain")
	MAP.link("contour",0.492691,"length")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("lfo",-0.743594,"sustain")
	MAP.link("lfo","lens")
	MAP.link("lfo",0.15931,"tone")
	MAP.link("lfo",0.343526,"length")
	MAP.link("lfo",0.024349,"time")
	MAP.link("lfo",0.171749,"spectre")
	MAP.link("lfo",-0.119702,"energy")
	MAP.link("notes",-0.0697077,"sustain")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.786134, c = 0.201423, v = 0.5, o = -2, act=true}
	cluster.cx[2] = {n = 0.64398, c = 0.201423, v = 0.5, o = -2, act=true}
	cluster.cx[3] = {n = 0.888271, c = 0.201423, v = 0.5, o = -1, act=true}
	cluster.cx[4] = {n = 0.874601, c = 0.201423, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.799285, c = 0.201423, v = 0.5, o = -1, act=true}
end
