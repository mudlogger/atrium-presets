patch.init = function()
	...
	P["spectre"] = 0.7384796
	P["spectre3"] = 0.9724552
	P["notes"] = 0.227398
	P["spectre2"] = 0.6682136
	P["phase"] = 0.0
	ST["octave"] = -2.0
	...
	_params.spectre1.vx = {0.5364478,0.6371729,0.5073149,0.3934005,0.2992739,0.5841873,0.6011947,0.8130675,0.426151,0.3801073,0.5385171}
	_params.spectre2.vx = {0.7445948,0.7423465,0.618484,0.6682136,0.4630259,0.5875165,0.6800266,0.9837329,0.7564327,0.5460113,0.6011567}
	_params.spectre3.vx = {1.0,0.8423467,0.9184836,0.9724552,0.5654579,0.5875165,0.7514365,1.0,1.0,0.7207035,0.6704683}
	...
	MAP.link("contour",0.430985,"sustain")
	MAP.link("contour",0.248871,"speed")
	MAP.link("contour",0.168883,"spectre1")
	MAP.link("contour",-0.0771029,"notes")
	MAP.link("contour",-0.677977,"energy")
	MAP.link("contour",0.168883,"spectre2")
	MAP.link("contour",0.159805,"tone")
	MAP.link("contour",0.168883,"spectre3")
	MAP.link("contour",0.239138,"volume")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",-0.203146,"sustain")
	MAP.link("freqs",0.0248749,"volume")
	MAP.link("lfo",0.504114,"timbre")
	MAP.link("lfo",-0.200898,"sustain")
	MAP.link("lfo",0.00360465,"notes")
	MAP.link("lfo",-0.0229085,"tempo")
	MAP.link("lfo",-0.4359,"spectre1")
	MAP.link("lfo",-0.205877,"speed")
	MAP.link("lfo",0.247752,"ramp")
	MAP.link("lfo",-0.113079,"length")
	MAP.link("lfo",-0.4359,"spectre2")
	MAP.link("lfo",1,"energy")
	MAP.link("lfo",0.361367,"tone")
	MAP.link("lfo",-0.4359,"spectre3")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.0140316, c = 0.811718, v = 0, o = -2, act=true}
	cluster.cx[2] = {n = 0.227398, c = 0.814681, v = 0, o = -2, act=true}
	cluster.cx[3] = {n = 0.388558, c = 0.814681, v = 0, o = -2, act=true}
	cluster.cx[4] = {n = 0.467761, c = 0.814681, v = 0, o = -2, act=true}
	cluster.cx[5] = {n = 0.516566, c = 0.814681, v = 0, o = -2, act=true}
end
