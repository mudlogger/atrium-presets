patch.init = function()
	...
	P["spectre"] = 0.0003513006
	P["spectre3"] = 0.5013083
	P["notes"] = 0.52298
	...
	_params.spectre1.vx = {0.1965743,0.4,0.3,0.5,0.367325,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.3965743,0.5,0.4,0.6,0.5259719,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.7965744,0.6,0.7,0.7,0.6961858,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("freqs",-0.102052,"length")
	MAP.link("freqs",0.0207332,"ramp")
	MAP.link("lfo",0.103946,"sustain")
	MAP.link("lfo",0.32367,"energy")
	MAP.link("clock","lens")
	MAP.link("clock",0.0813884,"tempo")
	MAP.link("clock",0.161742,"sustain")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.52298, c = 0.332842, v = 0.5, o = 0, act=true}
	cluster.cx[2] = {n = 0.547174, c = 0.332842, v = 0.5, o = 0, act=true}
	cluster.cx[3] = {n = 0.399627, c = 0.332842, v = 0.5, o = 0, act=true}
	cluster.cx[4] = {n = 0.661041, c = 0.332842, v = 0.5, o = -1, act=true}
	cluster.cx[5] = {n = 0.539623, c = 0.332842, v = 0.5, o = -1, act=true}
end
