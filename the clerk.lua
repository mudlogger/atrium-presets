patch.init = function()
	...
	_params.spectre1.vx = {0.5364478,0.6371729,0.5073149,0.8455939,0.7338158,0.5841873,0.6011947,0.8130675,0.426151,0.3801073,0.5385171}
	_params.spectre2.vx = {0.7445948,0.7423465,0.618484,0.9580427,0.8975678,0.5875165,0.6800266,0.9837329,0.7564327,0.5460113,0.6011567}
	_params.spectre3.vx = {1.0,0.8423467,0.9184836,1.0,1.0,0.5875165,0.7514365,1.0,1.0,0.7207035,0.6704683}
	...
	MAP.link("contour",-0.129355,"sustain")
	...
	MAP.link("freqs",0.0708928,"sustain")
	MAP.link("freqs",0.0248749,"volume")
	MAP.link("lfo","lens")
	MAP.link("lfo",0.385619,"sustain")
	MAP.link("lfo",-0.0229085,"tempo")
	MAP.link("lfo",-0.205877,"speed")
	MAP.link("lfo",0.307058,"timbre")
	MAP.link("lfo",-0.578757,"spectre1")
	MAP.link("lfo",-0.113079,"length")
	MAP.link("lfo",0.247752,"ramp")
	MAP.link("lfo",-0.109375,"tone")
	MAP.link("lfo",0.0874675,"energy")
	MAP.link("lfo",-0.578757,"spectre2")
	MAP.link("lfo",-0.578757,"spectre3")
	gesture.G[1].mute = 0
	gesture.G[1].flip = 0
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.0140316, c = 0.500894, v = 0, o = -2, act=true}
	cluster.cx[2] = {n = 0.227398, c = 0.814681, v = 0, o = -2, act=true}
	cluster.cx[3] = {n = 0.198042, c = 0.589062, v = 0, o = -1, act=true}
	cluster.cx[4] = {n = 0.467761, c = 0.814681, v = 0, o = -2, act=true}
	cluster.cx[5] = {n = 0.50018, c = 0.814681, v = 0, o = -2, act=true}
end
