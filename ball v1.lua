patch.init = function()
	...
	_params.spectre1.vx = {0.1965743,0.3453715,0.3,0.5,0.4527878,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.3965743,0.4453714,0.4,0.6,0.6114351,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.7965744,0.5453712,0.7,0.7,0.7816493,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",0.0525118,"sustain")
	MAP.link("contour",0.158072,"timbre")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.721916,"length")
	MAP.link("lfo",0.427243,"spectre1")
	MAP.link("lfo",0.181675,"stretchR")
	MAP.link("lfo",-0.843058,"length")
	MAP.link("lfo",0.427243,"spectre2")
	MAP.link("lfo",0.00762168,"energy")
	MAP.link("lfo",0.48567,"stretchL")
	MAP.link("lfo",0.427243,"spectre3")
	MAP.link("notes",0.0677002,"notes")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 0.26459, c = 0.917704, v = 0.5, o = 1, act=true}
	cluster.cx[2] = {n = 0.15974, c = 0.917704, v = 0.5, o = 1, act=true}
	cluster.cx[3] = {n = 0.00151212, c = 0.917704, v = 0.5, o = 1, act=true}
	cluster.cx[4] = {n = 0.26459, c = 0.917704, v = 0.5, o = 0, act=true}
	cluster.cx[5] = {n = 0.894228, c = 0.782988, v = 0.5, o = -1, act=true}
end
