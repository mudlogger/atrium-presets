patch.init = function()
	...
	_params.spectre1.vx = {0.1965743,0.4,0.3,0.5,0.5247831,0.5,0.4774904,0.4527878,0.241575,0.2657811,0.3746744}
	_params.spectre2.vx = {0.3965743,0.5,0.4,0.6,0.6834304,0.5,0.548691,0.6114351,0.5673178,0.4293588,0.4319967}
	_params.spectre3.vx = {0.7965744,0.6,0.7,0.7,0.8536446,0.5,0.6201009,0.7816493,0.8831592,0.604051,0.5013083}
	...
	MAP.link("contour",-0.377677,"sustain")
	MAP.link("contour",-0.945456,"tempo")
	MAP.link("contour",-0.495014,"speed")
	MAP.link("strum",2,"gate")
	MAP.link("sustain","gate")
	MAP.link("freqs",0.800627,"tempo")
	MAP.link("freqs",-0.578544,"sustain")
	MAP.link("lfo","scale_sm")
	MAP.link("lfo",0.41342,"sustain")
	MAP.link("lfo","octave_up")
	MAP.link("lfo",0.227719,"notes")
	MAP.link("lfo",0.397077,"ramp")
	MAP.link("lfo","drone")
	MAP.link("lfo",0.135888,"spectre1")
	MAP.link("lfo","lens")
	MAP.link("lfo",0.795678,"time")
	MAP.link("lfo",-0.491685,"stretchR")
	MAP.link("lfo",0.165487,"energy")
	MAP.link("lfo",0.119789,"spectre")
	MAP.link("lfo",0.135888,"spectre2")
	MAP.link("lfo",-0.297839,"length")
	MAP.link("lfo",0.317283,"stretchL")
	MAP.link("lfo",0.135888,"spectre3")
	...
	gesture.G[5].Mlink = 0
	cluster.cx[1] = {n = 1, c = 0.5, v = 0.5, o = -2, act=true}
	cluster.cx[2] = {n = 1, c = 0.00058041, v = 0.5, o = -2, act=true}
end
