patch.init = function()
	...
	cluster.cx[2] = {n = 0.89516, c = 0.5, v = 0.5, o = 1, act=true}
	cluster.cx[3] = {n = 0.652319, c = 0.5, v = 0.5, o = 2, act=true}
	cluster.cx[4] = {n = 0.927632, c = 1, v = 0.5, o = 2, act=true}
	cluster.cx[5] = {n = 0.927632, c = 1, v = 0.5, o = 0, act=true}
end
